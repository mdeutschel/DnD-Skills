...
- [Klassen](#klassen)
- [Klassen-Fachbegriffe](#klassen-fachbegriffe)
- [Spezies](#spezies)
...
| Deutsch | Englisch |
|---|---|
| Wuchtschaden | Bludgeoning |
| Stichschaden | Piercing |
| Hiebschaden | Slashing |
| Säureschaden | Acid |
| Blitzschaden | Lightning |
| Donnerschaden | Thunder |
| Feuerschaden | Fire |
| Frostschaden / Kälteschaden | Cold |
| Giftschaden | Poison |
| Gleißender Schaden | Radiant |
| Nekrotischer Schaden | Necrotic |
| Psychischer Schaden | Psychic |
| Schaden durch Energie / Energieschaden | Force |
...
| Barbar | Barbarian |
| Barde / Bardin | Bard |
| Druide / Druidin | Druid |
| Hexenmeister / Hexenmeisterin | Warlock |
| Kämpfer / Kämpferin | Fighter |
| Kleriker / Klerikerin | Cleric |
| Magier / Magierin | Wizard |
| Mönch / Mönchin | Monk |
| Paladin | Paladin |
| Schurke / Schurkin | Rogue |
| Waldläufer / Waldläuferin | Ranger |
| Zauberer / Zauberin | Sorcerer |
...
| Zaubermerkmal | Spellcasting Feature |
| Trick (Zaubertrick) | Cantrip |
| Ritual (Zauber) | Ritual |
| Düsterpirscher (Waldläufer-Unterklasse) | Gloom Stalker |
...
| Streifender Treffer | Glancing Blow (kampagnen-spezifisch) |
| Hinterhalt | Ambush |
| Überraschung (Effekt) | Surprised |
| Volle Deckung | Total Cover |
| Dreiviertel-Deckung | Three-Quarters Cover |
...
| Konzentrationszauber | Concentration Spell |
| Anti-Magie-Feld | Antimagic Field |
| Konter-Zauber | Counterspell |
| Höhere Stufe (gewirkt mit) | Cast at Higher Level |
| Komponenten (V, S, M) | Components (V, S, M) |
| Verbal | Verbal |
| Somatisch | Somatic |
| Materiell | Material |
...
| Spielleiter / Spielleiterin (SL/GM) | Game Master / Dungeon Master (GM/DM) |
| Nicht-Spieler-Charakter (NSC) | Non-Player Character (NPC) |
| Spielercharakter (SC) | Player Character (PC) |
| Sitzung | Session |
| Kampagne | Campaign |
| Quest | Quest / Adventure |
| Begegnung | Encounter |
| Schauplatz | Setting |
| Ausrichtung (Gesinnung) | Alignment |
